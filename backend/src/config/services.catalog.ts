...
export const servicesCatalog: ServiceCatalogEntry[] = [
  ...
  },
  {
    ...
    description: 'A complete marketing or business website — Home, About, Services, Contact, Blog — built on a modern stack and deployed to your domain.',
    icon: 'code',
    img: '/images/services/software-dev.jpg',
    productized: true,
    price: 500000,
    ...
    refundPolicy: 'Full refund within 24 hours of purchase if work has not started. After that, refund is pro-rated based on work completed.',
    faq: [
      { q: 'Can I add more than 6 pages?', a: 'Each additional page is ₦25,000. Or request a custom quote for larger sites.' },
      { q: 'Is a CMS included?', a: 'We use a developer-friendly content structure so you can edit copy easily without breaking the site. Full CMS (e.g. Sanity, Strapi) is a custom add-on.' },
    ],
    intakeFields: [
      { name: 'businessName', label: 'Business / product name', type: 'text', required: true, placeholder: 'Acme Inc.' },
      { name: 'pages', label: 'Which pages do you need? (comma-separated)', type: 'textarea', required: true, placeholder: 'Home, About, Services, Pricing, Blog, Contact' },
  ...
  },
  {
    ...
    faq: [
      { q: 'What stack do you use?', a: 'React + TypeScript + Tailwind on the frontend; Node.js + Express + MongoDB on the backend. Adaptable on request.' },
  ...
  },
  {
    ...
    description: 'A cross-platform mobile app (iOS + Android) built with React Native — your idea shipped to the app stores in weeks, not months.',
    icon: 'smartphone',
    ...
    refundPolicy: 'Full refund within 24 hours of purchase if work has not started. Pro-rated otherwise.',
    faq: [
      { q: 'Will it work on both iOS and Android?', a: 'Yes — one React Native codebase ships to both platforms.' },
  ...
  },
  {
    ...
    description: 'A connected interactive dashboard built on Metabase or Power BI showing the KPIs that actually matter to your business.',
    icon: 'bar-chart',
    ...
    whatsNotIncluded: [
      'BI tool license fees (Metabase free tier or your existing license)',
    ...
    refundPolicy: 'Full refund within 24 hours of purchase if work has not started. Pro-rated otherwise.',
    faq: [
      { q: 'What data sources do you support?', a: 'PostgreSQL, MySQL, MongoDB, Google Sheets, Stripe, Shopify, and most common SaaS APIs.' },
      { q: 'Do you provide hosting?', a: 'For Metabase, yes (we can host it for you). Power BI uses your existing Microsoft subscription.' },
    ],
    intakeFields: [
  ...
  /* ─── Larger productized packages (fixed scope, fixed price) ────────── */
  {
    ...
    description: 'A larger web application beyond the MVP package — up to 3 user workflows, role-based access control, third-party integrations, and an admin panel. Built end-to-end on React + Node + MongoDB.',
    icon: 'code',
    img: '/images/services/software-dev.jpg',
    productized: true,
    price: 3500000,
  ...
  },
  {
    ...
    deliverables: [
      ...
      'Deployment script (Flask / FastAPI)',
