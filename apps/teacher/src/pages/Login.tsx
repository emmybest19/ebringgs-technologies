...
export default function TeacherLogin() {
  useSEO({ title: 'Teacher Sign in', siteName: 'E-Bringgs Teacher Portal', noIndex: true });
    ...
    <div className="min-h-screen bg-linear-to-br from-slate-900 via-slate-950 to-cyan-950 flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          <div className="inline-flex w-14 h-14 bg-linear-to-br from-cyan-500 to-cyan-700 rounded-2xl items-center justify-center mb-4 shadow-lg shadow-cyan-500/30">
            <GraduationCap size={28} className="text-white" />
          </div>
          <h1 className="text-3xl font-extrabold text-white mb-2">Teacher Portal</h1>
          <p className="text-slate-400 text-sm">Sign in to manage your classes</p>
        </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            >
              {isLoading ? (
                ...
                <>Sign in to teacher portal <ArrowRight size={16} /></>
              )}
            </button>
          </form>
