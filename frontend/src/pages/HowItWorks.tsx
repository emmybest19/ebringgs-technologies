...
export default function HowItWorks() {
  ...
  return (
    <div className="bg-white dark:bg-slate-900">
      ...
      <section className="bg-gradient-to-br from-slate-50 to-teal-50 dark:from-slate-950 dark:to-teal-950 py-20 px-4">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="relative">
            {/* Connector line */}
            <div className="hidden md:block absolute top-8 left-0 right-0 h-0.5 bg-gradient-to-r from-teal-200 via-teal-400 to-teal-200 dark:from-teal-800 dark:via-teal-600 dark:to-teal-800" />
      ...
      <section className="relative py-20 px-4 text-center text-white overflow-hidden">
        ...
        <div className="absolute inset-0 bg-gradient-to-br from-teal-700/90 to-emerald-800/90" />
        <div className="relative">
